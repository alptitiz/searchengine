...
public class Date {
    ...
    // Tage bis Jahresende, den durch 'this' beschriebenen ausgeschlossen
    ...
    // Tage seit Jahresanfang, den durch 'this' beschriebenen eingeschlossen
    ...
    // 'true' gdw. das übergebene Jahr ein Schaltjahr ist
    public static boolean isLeapYear(int year) {
        return year % 4 == 0 && (year % 100 != 0 || year % 400 == 0);
    }

    // Anzahl an Tagen des übergebenen Monats in dem übergebenen Jahr
    ...
    // Anzahl an Tagen im übergebenen Jahr
    public static int daysInYear(int year) {
        return isLeapYear(year) ? 366 : 365;
    }

    // Testet, ob das übergebene Datum valide ist
